...
for(let i = 0;i<images.length;i++){
    ...
    card.classList.add("a_card");
    card.innerHTML=`<img class="dio" src="${images[i].url}" alt="">`
    console.log(card)
    padre.append(card)
}
const imgPrincipale=document.getElementById("immagineprincipale")
imgPrincipale.classList.add("tutto")
const img=document.createElement("div")
img.classList.add("tutto")
